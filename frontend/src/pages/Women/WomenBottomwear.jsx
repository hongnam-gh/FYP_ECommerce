...
const WomenBottomwear = () => {
  ...
  const applyFilter = () => {
    ...
    productsCopy = productsCopy.filter(item => item.category === 'Women' && ['Bottomwear', 'Bottom Wear'].includes(item.subCategory))
  ...
  return (
    <>
      <PageBanner page='women-bottomwear' title='WOMEN BOTTOMWEAR' />
