...
const WomenTopsShirts = () => {
  ...
  const applyFilter = () => {
    ...
    productsCopy = productsCopy.filter(item => item.category === 'Women' && ['Topwear', 'TopsShirts', 'Tops & Shirts'].includes(item.subCategory))
  ...
  return (
    <>
      <PageBanner page='women-tops-shirts' title='WOMEN TOPS & SHIRTS' />
...
export default WomenTopsShirts
