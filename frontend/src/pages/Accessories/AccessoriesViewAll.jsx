...
const AccessoriesViewAll = () => {
  ...
  return (
    <>
      <PageBanner page='accessories-view-all' title='ACCESSORIES COLLECTION' />
      <div className='chung-page'>
      <ProductFilterSidebar showFilter={showFilter} setShowFilter={setShowFilter} products={products} filterCategory='Accessories' advancedFilters={advancedFilters} setAdvancedFilters={setAdvancedFilters} showSubCategory newArrivalOnly={newArrivalOnly} setNewArrivalOnly={setNewArrivalOnly} setPriceRange={setPriceRange} sortType={sortType} setSortType={setSortType} />
...
export default AccessoriesViewAll
