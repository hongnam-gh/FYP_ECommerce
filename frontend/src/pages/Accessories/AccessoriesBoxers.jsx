...
const AccessoriesBoxers = () => {
  ...
  const applyFilter = () => {
    ...
    productsCopy = productsCopy.filter(item => item.category === 'Accessories' && item.subCategory === 'Boxers')
  ...
  return (
    <>
      <PageBanner page='accessories-boxers' title='ACCESSORIES BOXERS' />
...
export default AccessoriesBoxers
