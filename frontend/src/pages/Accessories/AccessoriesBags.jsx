...
const AccessoriesBags = () => {
  ...
  const applyFilter = () => {
    ...
    productsCopy = productsCopy.filter(item => item.category === 'Accessories' && item.subCategory === 'Bags')
  ...
  return (
    <>
      <PageBanner page='accessories-bags' title='ACCESSORIES BAGS' />
...
export default AccessoriesBags
