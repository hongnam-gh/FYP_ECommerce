...
const AccessoriesHats = () => {
  ...
  const applyFilter = () => {
    ...
    productsCopy = productsCopy.filter(item => item.category === 'Accessories' && item.subCategory === 'Hats')
  ...
  return (
    <>
      <PageBanner page='accessories-hats' title='ACCESSORIES HATS' />
...
export default AccessoriesHats
