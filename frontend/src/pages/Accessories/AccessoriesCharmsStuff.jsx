...
const AccessoriesCharmsStuff = () => {
  ...
  const applyFilter = () => {
    ...
    productsCopy = productsCopy.filter(item => item.category === 'Accessories' && ['CharmsStuff', 'Charms & Stuff'].includes(item.subCategory))
...
export default AccessoriesCharmsStuff
