...
const MenOuterwears = () => {
  ...
  const applyFilter = () => {
    ...
    productsCopy = productsCopy.filter(item => item.category === 'Men' && ['Winterwear', 'Outerwears', 'Outerwear & Jacket'].includes(item.subCategory))
