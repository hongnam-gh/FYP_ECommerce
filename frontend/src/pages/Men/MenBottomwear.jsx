...
const MenBottomwear = () => {
  ...
  const applyFilter = () => {
    ...
    productsCopy = productsCopy.filter(item => item.category === 'Men' && ['Bottomwear', 'Bottom Wear'].includes(item.subCategory))
  ...
  return (
    <>
      <PageBanner page='men-bottomwear' title='MEN BOTTOMWEAR' />
