...
const MenTopsShirts = () => {
  ...
  const applyFilter = () => {
    ...
    productsCopy = productsCopy.filter(item => item.category === 'Men' && ['Topwear', 'TopsShirts', 'Tops & Shirts'].includes(item.subCategory))
  ...
  return (
    <>
      <PageBanner page='men-tops-shirts' title='MEN TOPS & SHIRTS' />
