...
const CollectionView = () => {
    ...
    const fetchCollection = async () => {
      try {
        ...
        if (response.data.success) {
          const selectedCollection = response.data.collections.find((item) => item.path === `/collection/${collectionRoute}`)
  ...
  if (!collection) return <Navigate to='/collection/view-all' replace />
