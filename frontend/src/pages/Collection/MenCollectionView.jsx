...
const MenCollectionView = () => {
    ...
    const fetchCollection = async () => {
      try {
        ...
        if (response.data.success) {
          const selectedCollection = response.data.collections.find((item) => item.path === `/collection/${collectionRoute}` && item.gender === 'Men')
  ...
  if (!collection) return <Navigate to='/men-collection' replace />
...
export default MenCollectionView
