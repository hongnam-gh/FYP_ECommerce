...
const NewArrivalsMen = () => {
  ...
  const applyFilter = () => {
    ...
    productsCopy = productsCopy.filter(item => item.category === 'Men' && item.newarrival)
  ...
  return (
    <>
      <PageBanner page='new-arrivals-men' title='MEN NEW ARRIVALS' />
      <div className='chung-page'>
      <ProductFilterSidebar showFilter={showFilter} setShowFilter={setShowFilter} products={products} filterCategory='Men' advancedFilters={advancedFilters} setAdvancedFilters={setAdvancedFilters} newArrivalOnly={true} newArrivalLocked setPriceRange={setPriceRange} sortType={sortType} setSortType={setSortType} />
