...
const NewArrivalsWomen = () => {
  ...
  const applyFilter = () => {
    ...
    productsCopy = productsCopy.filter(item => item.category === 'Women' && item.newarrival)
  ...
  return (
    <>
      <PageBanner page='new-arrivals-women' title='WOMEN NEW ARRIVALS' />
      <div className='chung-page'>
      <ProductFilterSidebar showFilter={showFilter} setShowFilter={setShowFilter} products={products} filterCategory='Women' advancedFilters={advancedFilters} setAdvancedFilters={setAdvancedFilters} newArrivalOnly={true} newArrivalLocked setPriceRange={setPriceRange} sortType={sortType} setSortType={setSortType} />
